...
Usage:
    make seed
    # or: uv run python cloud/src/chainwatch_cloud/scripts/seed_dev.py
"""
...
from chainwatch_cloud.database import async_session_factory
...
DEV_API_KEY = "cw_dev_test_key_abc123"
...
async def _seed_org(db: AsyncSession) -> None:
    ...
    db.add(org)
    await db.flush()
    print(f"  org   {DEV_ORG_ID} created (ChainWatch Dev)")
...
if __name__ == "__main__":
    print("Seeding ChainWatch dev database...")
